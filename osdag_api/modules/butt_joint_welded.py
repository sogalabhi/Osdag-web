...
def get_required_keys() -> List[str]:
    ...
    print("in butt_joint_welded.py: get_required_keys called, returning:", req_keys)
    return req_keys

def validate_input(input_values: Dict[str, Any]) -> None:
    print("in butt_joint_welded.py: validate_input called with input_values:", input_values)
    required_keys = get_required_keys()
    print("in butt_joint_welded.py: Required keys:", required_keys)
    missing_keys = contains_keys(input_values, required_keys)
    print("in butt_joint_welded.py: Missing keys:", missing_keys)
    if missing_keys is not None:
        print("in butt_joint_welded.py: Missing key detected:", missing_keys[0])
        raise MissingKeyError(missing_keys[0])

    # Commented until knowing exact types to validate the keys against.
    # # Validate Connector.Material
    # print("in butt_joint_welded.py: Validating Connector.Material")
    # if not isinstance(input_values["Connector.Material"], str):
    #     print("in butt_joint_welded.py: Invalid type for Connector.Material")
    #     raise InvalidInputTypeError("Connector.Material", "str")

    # # Validate Design.Design_Method
    # print("in butt_joint_welded.py: Validating Design.Design_Method")
    # if not isinstance(input_values["Design.Design_Method"], str):
    #     print("in butt_joint_welded.py: Invalid type for Design.Design_Method")
    #     raise InvalidInputTypeError("Design.Design_Method", "str")

    # # Validate Detailing.Corrosive_Influences
    # print("in butt_joint_welded.py: Validating Detailing.Corrosive_Influences")
    # if not is_yes_or_no(input_values["Detailing.Corrosive_Influences"]):
    #     print("in butt_joint_welded.py: Invalid value for Detailing.Corrosive_Influences")
    #     raise InvalidInputTypeError("Detailing.Corrosive_Influences", "'Yes' or 'No'")

    # # Validate Detailing.Edge_type
    # print("in butt_joint_welded.py: Validating Detailing.Edge_type")
    # if not isinstance(input_values["Detailing.Edge_type"], str):
    #     print("in butt_joint_welded.py: Invalid type for Detailing.Edge_type")
    #     raise InvalidInputTypeError("Detailing.Edge_type", "str")

    # # Validate Detailing.Gap
    # print("in butt_joint_welded.py: Validating Detailing.Gap")
    # detailing_gap = input_values["Detailing.Gap"]
    # if (not isinstance(detailing_gap, str)
    #         or not int_able(detailing_gap)):
    #     print("in butt_joint_welded.py: Invalid type for Detailing.Gap")
    #     raise InvalidInputTypeError("Detailing.Gap", "str where str can be converted to int")

    # # Validate Load.Axial
    # print("in butt_joint_welded.py: Validating Load.Axial")
    # load_axial = input_values["Load.Axial"]
    # if (not isinstance(load_axial, str)
    #         or not int_able(load_axial)):
    #     print("in butt_joint_welded.py: Invalid type for Load.Axial")
    #     raise InvalidInputTypeError("Load.Axial", "str where str can be converted to int")

    # # Validate Material
    # print("in butt_joint_welded.py: Validating Material")
    # if not isinstance(input_values["Material"], str):
    #     print("in butt_joint_welded.py: Invalid type for Material")
    #     raise InvalidInputTypeError("Material", "str")

    # # Validate Member.Profile
    # print("in butt_joint_welded.py: Validating Member.Profile")
    # if not isinstance(input_values["Member.Profile"], str):
    #     print("in butt_joint_welded.py: Invalid type for Member.Profile")
    #     raise InvalidInputTypeError("Member.Profile", "str")

    # # Validate Member.Designation
    # print("in butt_joint_welded.py: Validating Member.Designation")
    # if not isinstance(input_values["Member.Designation"], str):
    #     print("in butt_joint_welded.py: Invalid type for Member.Designation")
    #     raise InvalidInputTypeError("Member.Designation", "str")

    # # Validate Member.Length
    # print("in butt_joint_welded.py: Validating Member.Length")
    # if not isinstance(input_values["Member.Length"], str):
    #     print("in butt_joint_welded.py: Invalid type for Member.Length")
    #     raise InvalidInputTypeError("Member.Length", "str")

    # # Validate Conn_Location
    # print("in butt_joint_welded.py: Validating Conn_Location")
    # if not isinstance(input_values["Conn_Location"], str):
    #     print("in butt_joint_welded.py: Invalid type for Conn_Location")
    #     raise InvalidInputTypeError("Conn_Location", "str")

    # # Validate Module
    # print("in butt_joint_welded.py: Validating Module")
    # if not isinstance(input_values["Module"], str):
    #     print("in butt_joint_welded.py: Invalid type for Module")
    #     raise InvalidInputTypeError("Module", "str")

    # # Validate Connector.Plate.Thickness_List
    # print("in butt_joint_welded.py: Validating Connector.Plate.Thickness_List")
    ...
    #     print("in butt_joint_welded.py: Invalid type for Connector.Plate.Thickness_List")
...
def create_module() -> ButtJointWelded:
    print("in butt_joint_welded.py: create_module called")
    module = ButtJointWelded()
    print("in butt_joint_welded.py: ButtJointWelded instance created:", module)
    module.set_osdaglogger(None)
    print("in butt_joint_welded.py: set_osdaglogger called with None")
    return module

def create_from_input(input_values: Dict[str, Any]) -> ButtJointWelded:
    try:
        module = create_module()
        print("in butt_joint_welded.py: Module created successfully")
    except Exception as e:
        print("in butt_joint_welded.py: Exception in create_module:", e)
        print("in butt_joint_welded.py: Error in creating module")
    ...
    try:
        ...
        input_values["Weld.Type"] = "Shop Weld"
        module.set_input_values(input_values)
        print("in butt_joint_welded.py: set_input_values called successfully")
    except Exception as e:
        print(type(e))
        print("in butt_joint_welded.py: Exception in set_input_values:", e)
        print("in butt_joint_welded.py: Error in setting the input values")
    
    return module

def generate_output(input_values: Dict[str, Any]) -> Dict[str, Any]:
    print("in butt_joint_welded.py: generate_output called with input_values:", input_values)
    output = {}
    module = create_from_input(input_values)
    print("in butt_joint_welded.py: Module after create_from_input:", module)
    print("in butt_joint_welded.py: type of module:", type(module))
    raw_output_text = module.output_values(True)
    print("in butt_joint_welded.py: raw_output_text:", raw_output_text)
    # raw_output_spacing = module.spacing(True)
    # print("in butt_joint_welded.py: raw_output_spacing:", raw_output_spacing)
    # raw_output_capacities = module.capacities(True)
    # print("in butt_joint_welded.py: raw_output_capacities:", raw_output_capacities)
    # raw_output_bolt_capacity = module.bolt_capacity_details(True)
    # print("in butt_joint_welded.py: raw_output_bolt_capacity:", raw_output_bolt_capacity)
    logs = module.logs
    print("in butt_joint_welded.py: logs:", logs)
    raw_output = raw_output_text
    print("in butt_joint_welded.py: raw_output combined:", raw_output)
    for param in raw_output:
        print("in butt_joint_welded.py: Processing param:", param)
        if param[2] == "TextBox":
            key = param[0]
            label = param[1]
            value = param[3]
            ...
            print(f"in butt_joint_welded.py: Added output[{key}] = {output[key]}")
    print("in butt_joint_welded.py: Final output dict:", output)
    print("in butt_joint_welded.py: Output keys:", list(output.keys()))
    print("in butt_joint_welded.py: Returning logs:", logs)
    return output, logs
...
def create_cad_model(input_values: Dict[str, Any], section: str, session: str) -> str:
    ...
    try: 
        cdl = CommonDesignLogic(None, '', KEY_DISP_BUTTJOINTWELDED , module.mainmodule)
    except Exception as e : 
