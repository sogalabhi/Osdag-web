...
const WeldSectionModal = ({ module, inputs, setInputs, designPrefInputs, setDesignPrefInputs, isInputLocked }) => {
    const isSimpleConnection = module && SIMPLE_CONNECTION_WELD_MODULES.includes(module);
                ...
                <div className='sub-container'>
                    <div className='input-cont'>
                        ...
                        <div>
                            ...
                            >
                                    <Option value="Shop weld">{isSimpleConnection ? "Shop weld" : "Shop Weld"}</Option>
                                    <Option value="Field weld">{isSimpleConnection ? "Field weld" : "Field Weld"}</Option>
                            </Select>
                        </div>
                    </div>
                    <div className='input-cont'>
