...
const DetailingSectionModal = ({ module, designPrefInputs, setDesignPrefInputs, isInputLocked }) => {
                        ...
                        <div className='input-cont'>
                            ...
                            <div>
                                <Select disabled={isInputLocked} style={{ width: '200px', height: '25px', fontSize: '12px' }}
                                    ...
                                    onSelect={value => setDesignPrefInputs({ ...designPrefInputs, detailing_packing_plate: value })}
                                >
