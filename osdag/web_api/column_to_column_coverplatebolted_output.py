...
from osdag_api.modules.column_to_column_cover_plate_bolted_connection import *
...
class ColumnCoverPlateBoltedOutputData(APIView):
    ...
    def post(self, request):
        ...
        module_name = input_values.get('Module', 'Column-to-Column-Cover-Plate-Bolted-Connection')
