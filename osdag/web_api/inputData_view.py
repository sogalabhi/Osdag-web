...
from .inputdata.column_column_cover_plate_bolted_input import ColumnCoverPlateBoltedInputData
from .inputdata.column_column_end_plate_input import ColumnColumnEndPlateInputData
...
INPUT_DATA_FACTORY = {
    ...
    'Column-to-Column-Cover-Plate-Bolted-Connection' : ColumnCoverPlateBoltedInputData(),
    'Column-to-Column-End-Plate-Connection' : ColumnColumnEndPlateInputData(),
