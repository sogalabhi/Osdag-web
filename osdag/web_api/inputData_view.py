...
from .inputdata.compression_member_input import CompressionMemberInputData
...
INPUT_DATA_FACTORY = {
    ...
    'Axially-Loaded-Column': CompressionMemberInputData(),
    'AxiallyLoadedColumn': CompressionMemberInputData(),
}
