...
from osdag.models import Material, CustomMaterials, Bolt

class LapJointBoltedInputData(InputDataBase):
    def process(self, **kwargs):
        email = kwargs.get("email")

        print("Processing Lap Joint Bolted Input Data - Complete Dataset")
        ...
        print("Lap Joint Complete Response: ", {k: len(v) if isinstance(v, list) else v for k, v in response.items()})
