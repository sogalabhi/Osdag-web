...
from osdag_api.modules.column_to_column_end_plate import *
...
class ColumnColumnEndPlateOutputData(APIView):

    def post(self, request):
        # Get input values and module from request
        input_values = request.data
        module_name = input_values.get('Module', 'Column-to-Column-End-Plate-Connection')
