...
def _safe_image_path(filename: str) -> str:
    """
    Resolve image resource path without breaking design output generation when
    importlib package metadata is unavailable in some runtime setups.
    """
    try:
...
class FinPlateConnection(ShearConnection):
    ...
    def input_values(self):
        ...
        t15 = (KEY_IMAGE, None, TYPE_IMAGE, _safe_image_path("fin_cf_bw.png"), True, 'No Validator')
    ...
    def spacing(self, status):
        ...
        t99 = (None, 'Spacing Details', TYPE_SECTION,
            [_safe_image_path("spacing_3.png"), 400, 277, ""])  # [image, width, height, caption]
        spacing.append(t99)
    ...
    def capacities(self, status):
        ...
        t99 = (None, 'Failure Pattern due to Shear in Plate', TYPE_SECTION,
            [_safe_image_path("L_shear1.png"), 400, 210, "Block Shear Pattern"])  # [image, width, height, caption]
        ...
        t99 = (None, 'Failure Pattern due to Tension in Plate', TYPE_SECTION,
            [_safe_image_path("U.png"), 400, 202, "Block Shear Pattern"])  # [image, width, height, caption]
        capacities.append(t99)
