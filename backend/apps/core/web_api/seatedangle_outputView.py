...
# importing models
from apps.core.models import Columns, Beams, Bolt, Bolt_fy_fu, Material
from apps.core.models import Design

# importing serializers
from apps.core.serializers import Design_Serializer
...
class SeatedAngleOutputData(APIView):
    ...
    def post(self, request):
        ...
        module_name = input_values.get('Module', 'SeatedAngleConnection')
