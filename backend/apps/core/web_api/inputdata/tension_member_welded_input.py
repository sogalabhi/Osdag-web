...
from apps.core.models import Angles, Channels, Material, CustomMaterials

class TensionMemberWeldedInputData(InputDataBase):
    def process(self, **kwargs):
        email = kwargs.get("email")

        print("Processing Tension Member Welded Input Data - Complete Dataset")
