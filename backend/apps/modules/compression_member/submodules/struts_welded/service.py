"""
Struts Welded to End Gusset - Service Layer
...
class StrutsWeldedService:
    """Service class for Struts-Welded-Design module"""
    ...
    def calculate(inputs: dict, request=None, project_id=None, user_email=None) -> dict:
        ...
        """
        print("=" * 60)
        print("StrutsWeldedService.calculate() called")
        print("=" * 60)
        ...
        try:
            ...
            print("\n" + "=" * 60)
            print(" ERROR in StrutsWeldedService.calculate()")
            print("=" * 60)
