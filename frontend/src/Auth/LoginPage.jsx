...
const LoginPage = () => {
    ...
    return (
        <>
            <section className="flex justify-center items-center lg:h-screen h-auto min-h-screen lg:ml-[50px] ml-0 lg:mt-[50px] mt-0 w-full p-4 lg:p-0">
                <div className="w-full max-w-md bg-white rounded-lg p-3 lg:p-6">
                    {/* Logo */}
                    <img
                        src={icon}
                        alt="Osdag Logo"
                        className="mb-8 block lg:inline mx-auto lg:mx-0 max-w-full h-auto pl-0 lg:pl-[60px] lg:mb-0 mb-4"
                        height={150}
                        width={300}
                    />
