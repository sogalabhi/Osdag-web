...
class Connection(Main):
    ...
    def func_for_validation(self, design_dictionary):
        ...
        if len(missing_fields_list) == 0:
            if KEY_CONN in design_dictionary and design_dictionary[KEY_CONN] == VALUES_CONN_2[0]:
                ...
                flag1 = True
            if design_dictionary[KEY_MODULE] == KEY_DISP_FINPLATE or design_dictionary[KEY_MODULE] == 'FinPlateConnection':
    ...
    def save_design(self):
        ...
        if self.module == KEY_DISP_BASE_PLATE:  # base plate module
            ...
            if self.module == KEY_DISP_FINPLATE or self.module == 'FinPlateConnection' or self.module == KEY_DISP_ENDPLATE or self.module == 'EndPlateConnection':
                self.report_input = \
